...
function Doctorpredictionchart() {
    ...
    const handleSubmit = () => {
        navigate(`/doctorvisualization/${User[0].ID}`);
                            ...
                            <div>
                                <form onClick={handleSubmit}>
                                    ...
                                    <p>
                                        ...
                                        <br />
                                        <input className="ainput" type="text" name="sugar" value={User[0].BloodSugar} />
                                    </p>
                                    <p>
...
export default Doctorpredictionchart;
