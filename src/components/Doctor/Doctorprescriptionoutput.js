                ...
                <div className="apage">
                    <div className="ashcover" >
                        ...
                        <p>
                            ...
                            <br />
                            <input className="ainput" type="text" name="pno" value={records[0]?.ID || ''}/>
                        </p>
                        <p>
                            <label>Name</label>
                            <br />
                            <input className="ainput" type="text" name="name" value={records[0]?.Name || ''} />
                        </p>
                        <p>
                            <label>Age</label>
                            <br />
                            <input className="ainput" type="text" name="age" value={records[0]?.Age || ''} />
                        </p>
                        <p>
...
export default Doctorprescriptionoutput;
